...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto">
            <div class="flex justify-between items-center mb-4">
                <div class="flex space-x-2">
                    ...
                    <!-- Dropdown untuk Tahunan -->
                    <div class="relative group">
                        <button id="dropdownButton" class="bg-blue-600 text-white font-bold py-2 px-4 rounded-lg flex items-center space-x-2">
                            <i class="fas fa-calendar-year"></i> Bulanan
                            <i class="fas fa-caret-down ml-2"></i>
                        </button>
                        <div id="dropdownMenu" class="absolute right-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
                            <a href="/rekapTahunan" class="block px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition duration-300">Tahunan</a>
                        </div>
                    </div>
                    <a href="<?= base_url('rekap/bulanan/excel?month=' . $selectedMonth) ?>" class="flex items-center text-green-600 font-semibold py-1 px-2 rounded-lg border border-green-600 hover:bg-green-600 hover:text-white transition duration-300">
                        <i class="fas fa-file-excel text-xl mr-2"></i> Unduh Excel
                    </a>
                </div>

                <form method="get" action="<?= base_url('rekap/bulanan') ?>" class="flex space-x-4 items-center">
                    <input type="month" id="month" name="month" class="border border-gray-300 rounded py-2 px-4 w-48" value="<?= $selectedMonth ?>">
                    <button type="submit" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-500">Lihat</button>
                </form>
            </div>

            <h2 class="text-lg font-semibold mb-4">Rekap Dokumen untuk Bulan: <?= date('F Y', strtotime($selectedMonth)) ?></h2>
            <!-- Tabel Data -->
    ...
    <script>
        ...
        function printTable() {
            ...
            win.document.write('<h2 class="text-lg font-semibold mb-4">Rekap Dokumen untuk Bulan: <?= $selectedMonth ?></h2>');
